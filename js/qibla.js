...
// Компасът на телефона сочи магнитния север. В България той е ≈ 5–6.5° на изток от географския.
// Формулата е изведена от NOAA World Magnetic Model (WMM) за 35 точки в България през 2026 и 2029 г.
// (grid 41.3–44.1° с.ш. × 22.5–28.5° и.д.): грешка под 0.06°. Отклонението расте с ≈ 0.06° на година.
// Проверка: София 5.73°, Варна 6.36°, Видин 5.86° (WMM, 09.2026).
export function declination(p, date = new Date()) {
  const yr = date.getUTCFullYear() + date.getUTCMonth() / 12 - 2026;
