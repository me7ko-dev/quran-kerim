...
const SHELL = 'qk-shell-v11';
const DATA = 'qk-data-v1';
const SHELL_FILES = ['./', 'index.html', 'css/style.css', 'js/app.js', 'js/store.js', 'js/audio.js', 'js/prayer.js', 'js/qibla.js', 'js/intro.js', 'js/intro3d.js', 'css/intro.css', 'data/meta.json', 'data/prayer.json', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-192.png'];
